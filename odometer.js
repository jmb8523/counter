  ...
  fetch('https://staging.api.ctrlv.ca/api/corp/getAllTimeStatisticsForWebsite')
    ...
    .then((data) => {
      setTimeout(function() {
        odometerMinutesPlayed.innerHTML = data.res.minutes;
      })
      setTimeout(function() {
        odometerLoyaltyDollars.innerHTML = data.res.loyalty_dollars;
      }, delayInMilliseconds)
      setTimeout(function() {
        odometerAllTimeCustomers.innerHTML = data.res.all_time_customers;
      }, delayInMilliseconds * 2)
      setTimeout(function() {
        odometerUniqueCustomers.innerHTML = data.res.customers;
      }, (delayInMilliseconds * 3))
      setTimeout(function() {
        odometerAvailableGames.innerHTML = data.res.available_games;
      }, (delayInMilliseconds * 4))
      setTimeout(function() {
        odometerLocations.innerHTML = data.res.locations;
